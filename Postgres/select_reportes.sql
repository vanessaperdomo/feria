-- Reporte 1: Productos con su Empresa y Responsable
SELECT 
...
-- Reporte 2: Charlas con su Ponente y Feria
SELECT 
    c.titulo       AS "Charla",
...
JOIN Pabellon pa   ON e.idEmpresa = pa.idTematica   -- ⚠️ revisa esta relación
JOIN Feria f       ON pa.idFeria = f.idFeria;

-- Reporte 3: Visitantes registrados, con Feria, Charla y Demostración
SELECT 
    v.idVisitante  AS "ID",
